...
namespace JSLabs\Snowflake\Providers;
...
class SnowflakeServiceProvider extends ServiceProvider
{
    ...
    public function registerProviders()
    {
        ...
        $this->app->bind($instance, function ($app) use($instance) {
            ...
            $timestamp = $app['config']->get('snowflake.start');
            $resolver  = $app['config']->get('snowflake.resolver');
            
            return ($this->resolveDriver($instance))
     ...
     *
     * @param  string $key
     * @return \JSLabs\Snowflake\Contracts\SequenceResolver
     */
     ...
     *
     * @param  string $key
     * @return \JSLabs\Snowflake\Contracts\SnowflakeDriver
     */
