...
use JSLabs\Snowflake\Contracts\SnowflakeDriver;
use JSLabs\Snowflake\Contracts\SequenceResolver;
...
class Snowflake implements SnowflakeDriver 
{
   ...
   *
   * @var \JSLabs\Snowflake\SequenceResolver|null
   */
   ...
   * 
   * @param int $startTime
   * @return \JSLabs\Snowflake\Snowflake
   */
   ...
   *
   * @param  \JSLabs\Snowflake\SequenceResolver|callable $sequence
   * @return \JSLabs\Snowflake\Snowflake
   */
   ...
   *
   * @return \JSLabs\Snowflake\SequenceResolver|callable|null
   */
   ...
   *
   * @return \JSLabs\Snowflake\SequenceResolver
   */
   ...
   * Call resolver.
   *
   * @param  callable|\JSLabs\Snowflake\SequenceResolver $resolver
